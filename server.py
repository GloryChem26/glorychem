...
def load_questions_database():
    try:
        base_dir = os.path.dirname(__file__)  # thư mục chứa file .py
        file_path = os.path.join(base_dir, "static", "quiz", "questions.json")

        print("Đang load file từ:", file_path)  # debug

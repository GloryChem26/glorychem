...
<p>Điều chế: oxi hóa ethylene (C₂H₄ + O₂ → CH₃CHO), oxi hóa cumene (điều chế acetone cùng phenol).</p>`
            ...
            quiz: [
              ...
              { q: 'Sản phẩm chính của phản ứng cộng HCN vào acetaldehyde (CH₃CHO) là:', opts: ['CH₃CH(OH)CN', 'CH₃CH(CN)OH', 'CH₃CH₂CN', 'CH₃COCN'], ans: 0, explain: 'Cộng HCN vào nhóm C=O tạo cyanohydrin.' }
            ]
          },
...
<p>Ứng dụng: sản xuất dược phẩm (aspirin), phẩm nhuộm, chất bảo quản (benzoic acid, sorbic acid), sản xuất ester làm hương liệu, polymer (PET từ terephthalic acid).</p>`
            ...
            quiz: [
              { q: 'Công thức tổng quát của carboxylic acid no, đơn chức, mạch hở là:', opts: ['CₙH₂ₙO₂', 'CₙH₂ₙ₊₂O₂', 'CₙH₂ₙ₋₂O₂', 'CₙH₂ₙ₊₁COOH'], ans: 3, explain: 'CₙH₂ₙ₊₁COOH với n≥0.' },
